  ...
  return (
    <section className="py-20 px-4 bg-primary text-primary-foreground">
      <div className="max-w-4xl mx-auto text-center">
        <span className="inline-block px-4 py-2 bg-secondary text-secondary-foreground rounded-full text-sm font-medium mb-6 animate-fade-up hover:scale-105 transition-all duration-300">
          Let's Connect
        </span>
        ...
        <p className="text-lg mb-8 opacity-90 animate-fade-up" style={{ animationDelay: "0.3s" }}>
          ...
          your goals with budget-friendly, high-quality copy.
        </p>
